...
**Reglas del dominio (`Playlist`):** | Campo | Regla | |---|---| | Título / Artista | Obligatorios, únicos en combinación | | Género | Opcional | | Duración | 1–9 minutos | | Calificación | `*` a `*****` |
